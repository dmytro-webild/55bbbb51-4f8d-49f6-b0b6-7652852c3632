...
"
      ...
      carouselItems={[
        {
          ...
          imageAlt: "Experiencia brunch gourmet",
        },
        {
          id: "2",
        ...
        {
          id: "4",
          imageSrc: "http://img.b2bpic.net/free-photo/avocado-toast-with-poached-egg_23-2152010307.jpg",
          imageAlt: "Diseño instagrameable",
        },
        {
          id: "5",
          imageSrc: "http://img.b2bpic.net/free-photo/glass-cups-with-aromatic-wax_23-2147809206.jpg",
          imageAlt: "Servicio exclusivo",
        },
        {
          id: "6",
          imageSrc: "http://img.b2bpic.net/free-photo/hot-coffee-bean-smoked-deep-dark-background_633478-955.jpg",
          imageAlt: "Atmósfera Luun",
        },
      ]}
    />
  </div>
      ...
      accordionItems={[
        {
          ...
          content: "Seleccionamos granos de las mejores regiones, tostados localmente para resaltar notas únicas.",
        },
        {
          id: "f2",
          title: "Brunch Gourmet",
          content: "Platos que combinan técnica clásica con productos frescos de temporada.",
        },
        {
          id: "f3",
          title: "Diseño Estético",
          content: "Cada rincón es un espacio curado para creadores y momentos instagrameables.",
        },
      ]}
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          rating: 5,
          reviewCount: "70",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-different-fruits-composition-fresh-sliced-fruits-dark-background-health-ripe-fresh-fruit-mellow_140725-116448.jpg",
        },
        {
          id: "p6",
          brand: "Luun Signature",
          name: "Breakfast Sándwich",
          price: "$175 MXN",
          rating: 5,
          reviewCount: "110",
      ...
      testimonials={[
        {
          ...
          testimonial: "El lugar más estético de Mérida. Los huevos benedictinos son otro nivel.",
          rating: 5,
        ...
        },
        {
          id: "2",
          name: "Carlos E.",
          handle: "@carlos.viajero",
          testimonial: "Un oasis en Paseo Montejo. El café de especialidad es impecable.",
          rating: 5,
        ...
        },
        {
          id: "3",
          name: "Lucía P.",
          handle: "@lucia.gastronomia",
          testimonial: "Cada rincón es perfecto para fotos. El servicio es de primera.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Diego R.",
          handle: "@diego.foodie",
          testimonial: "La calidad de los ingredientes se nota en cada bocado. Imprescindible.",
          rating: 5,
        ...
        },
        {
          id: "5",
          name: "Elena T.",
          handle: "@elena.creativa",
          testimonial: "Mi lugar favorito para empezar el día. Creatividad y buen brunch.",
          rating: 5,
      ...
      faqs={[
        {
          ...
          content: "Sí, contamos con una amplia variedad de opciones vegetarianas frescas y balanceadas.",
        },
        {
          id: "q2",
          title: "¿Se necesita reservar?",
          content: "Recomendamos reservar los fines de semana a través de nuestro sitio web para asegurar tu lugar.",
        },
        {
          id: "q3",
          title: "¿Aceptan mascotas?",
          content: "Somos un café pet-friendly en nuestra terraza al aire libre.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      textarea={{
        name: "message",
        placeholder: "Detalles adicionales o alergias...",
        rows: 3,
        required: false,
      }}
